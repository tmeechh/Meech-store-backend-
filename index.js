...
// mongoose.connect(
//   'mongodb+srv://Tmeech:honesty%4001@cluster0.trfo1uf.mongodb.net/meechecommerce'
// );
...
//   // let userData = await userModel.findBy
...
//     unique: true,
//     required: true,
//     lowercase: true, // This ensures emails are stored in lowercase
//   },
...
// //creating enpoint to remove cartdata
// app.post('/removefromcart', fetchUser, async (req, res) => {
//   try {
//     const newCartItem = req.body;
//     let userData = await Users.findOne({ _id: req.user.id });

//     userData.cartData.filter(
